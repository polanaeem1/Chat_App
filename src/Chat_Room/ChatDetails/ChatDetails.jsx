...
const files = [
  ...
  { name: "Lec5 Summary.pdf", type: "PDF", size: "5MB", url: "/downloads/Lec5_Summary.pdf" },
];
    ...
    <div className='chat-details-container'>
      ...
      <div className="file-list-header">
        <div className="file-header-left">
          <FontAwesomeIcon icon={faFileLines} size='2x' style={{color: "#c7c7c7",}} className="folder-icon" />
